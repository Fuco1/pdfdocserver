...
public class UserServiceSoapBindingStub extends org.apache.axis.client.Stub implements cz.muni.fi.pa165.local.service.user.UserService {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {entity});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (cz.muni.fi.pa165.local.dto.User) _resp;
            } catch (java.lang.Exception _exception) {
                return (cz.muni.fi.pa165.local.dto.User) org.apache.axis.utils.JavaUtils.convert(_resp, cz.muni.fi.pa165.local.dto.User.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {name, password});
  ...
  throw axisFaultException;
    ...
    public boolean changePassword(long id, java.lang.String oldPassword, java.lang.String newPassword) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(id), oldPassword, newPassword});
